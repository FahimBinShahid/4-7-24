...
public class Main {
    public static void main(String[] args) {
        ...
        list.forEach((var myString) -> {
            ...
            System.out.println(myString + "'s first letter is " + first);
        });

        int result = calculator((var a, var b) -> {int c = a + b; return c;}, 5, 2);
        var result2 = calculator((a,b) -> a/b, 10.0,2.5);
        var result3 = calculator((a,b) -> a * b, 3.0,5.5);
        var result4 = calculator((a,b)-> a-b, 37,38);
        var result5 =calculator((a,b)-> a.toUpperCase() + " and " + b.toUpperCase(),"dijkstra","bellmen_ford");
        ...
        list.removeIf(s->s.equalsIgnoreCase("delta"));
        ...
        list.replaceAll(s-> s.charAt(1)+ " - " + s.toUpperCase());
        ...
        String[] randomList = randomlySelectedValues(15, names,
                () -> new Random().nextInt(0, names.length)); //() -> statement.

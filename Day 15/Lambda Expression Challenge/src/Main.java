...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String[] names = {"Santa", "Mariam" ,"Frankenstein", "David", "Pablo", "Vincent","Nicolas"};
        ...
        System.out.println("American --> Chinese ");  //reverese name
        ...
        System.out.println("---> Remove if first letter = last letter");
